...
namespace Vilma.Blazor.Components
{
    internal class VilmaJSInterop
    {
        ...
        {
            jsRuntime.InvokeVoidAsync("import", "./_content/Vilma.Blazor.Components/js/bootstrap.min.js");

            accordionModule = new(() => jsRuntime.InvokeAsync<IJSObjectReference>(
                "import", "./_content/Vilma.Blazor.Components/js/vilma.accordion.js").AsTask());

            modalModule = new(() => jsRuntime.InvokeAsync<IJSObjectReference>(
                "import", "./_content/Vilma.Blazor.Components/js/vilma.modal.js").AsTask());
        }
