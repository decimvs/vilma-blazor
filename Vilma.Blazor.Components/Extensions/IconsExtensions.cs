namespace Vilma.Blazor.Components.Extensions
{
    internal static partial class Icons
    {
        ...
        /// <returns></returns>
        internal static string GetIconSvg(this Vilma.Blazor.Components.Icons icon, int width = 16, int height = 16, string? textColor = null)
        {
